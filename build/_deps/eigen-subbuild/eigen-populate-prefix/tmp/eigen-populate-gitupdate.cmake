...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "3.4.0"
  WORKING_DIRECTORY "D:/Files/Programming/VSCode/cpp/Projects/mom_solver/build/_deps/eigen-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Files/Programming/VSCode/cpp/Projects/mom_solver/build/_deps/eigen-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Files/Programming/VSCode/cpp/Projects/mom_solver/build/_deps/eigen-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
